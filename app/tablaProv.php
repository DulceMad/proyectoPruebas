<?php
    ...
    $categoria = "SELECT * FROM suppliers";
?> 
...
<div class="container-md">
    ...
    <div class="col-xs-10 col-md-5 input-group ">
        <a href="NuevoProvedor.php">
                <button class="btn btn-primary btn-sm" type="submit"><b>NUEVO PROVEEDOR</b></button>
        </a>
        <p></p>
    </div>
            ...
            <tbody>
                <tr>
                   ...
                   while($row=mysqli_fetch_assoc($resultado)) { ?> 
                    ...
                    <td><a class="btn btn-primary btn-sm" href="formProv.php?id=<?php echo $row['id']; ?>">EDITAR</a>
                        <a class="btn btn-danger btn-sm sm-4" href="eliminarProv.php?id=<?php echo $row['id']; ?>">ELIMINAR</a>
