...
<div class="container-md">
    ...
    <div style="margin-left: 5%;">
        <form action="registrarProv.php" method="POST">
            <div class="container py-5 h-100">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-12 col-md-8 col-lg-6 col-xl-10">
                        <div class="card shadow-2-strong" style="background-color: #828282;" >
                            <div class="card-body p-5 text-">
                                <h5 class="form-label" >Número de proveedor</h5>
                                    <div class="form-outline mb-4">
                                        <input name="id" placeholder="No.Proveedor"  type="number" class="form-control form-control-lg"/>
                                    </div>
                                <h5  class="form-label" >Nombre del proveedor</h5>
                                <div class="form-outline mb-4">
                                    <input name="suppliername" placeholder="Nombre del proveedor " type="text" class="form-control form-control-lg"/>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    <input name="supplieremail" placeholder="Correo electrónico" type="email" class="form-control form-control-lg"/>
                                </div>
