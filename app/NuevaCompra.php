...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#004173;">
    <div class="container-fluid" style="padding:15px ;">
        ...
        <div class="navbar-collapse collapse" id="navbarScroll">
            ...
            <a href="Perfil.html">
                <button class="btn btn" type="submit" style="color:white;">Mi cuenta</button>
            </a>
        </div>
    </div>
</nav>
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-10">
                        <div class="card shadow-2-strong" style="background-color: #828282;" >
                            <div class="card-body p-5 text-">
                                <h5 class="form-label" >Número de orden</h5>
                                    <div class="form-outline mb-4">
                                        <input name="idOrder" placeholder="No.Orden"  type="number" class="form-control form-control-lg"/>
                                    </div>
                                ...
                                <div class="form-outline mb-4">
                                    <input name="dateOrder" placeholder="Fecha " type="date" class="form-control form-control-lg"/>
                                </div>
                                <h5 class="form-label" >Cantidad</h5>
                                <div class="form-outline mb-4">
                                    <input name="quantity" placeholder="Cantidad"  type="number" class="form-control form-control-lg"/>
                                </div>
                                <a href="AdministracionPedidos.html"> <button class="btn btn-dark btn-lg btn-block"
