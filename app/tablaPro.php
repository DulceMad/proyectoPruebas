<?php
    ...
    $product = "SELECT p.*, s.suppliername, c.categoryname FROM products p
...
<div class="container-md">
    ...
    <div class="col-xs-10 col-md-5 input-group ">
        <a href="NuevoProd.php">
                <button class="btn btn-primary btn-sm" type="submit"><b>NUEVO PRODUCTO</b></button>
        </a>
        <p></p>
    </div>
    ...
    <div class="table-responsive-sm" style="margin-left: 2%; margin-bottom: 2%; margin-top: 2%;">
        <table class="table table-dark table-striped">
            ...
            <tbody>
                <tr>
                   <?php $resultado = mysqli_query($conexion, $product);
                   while($row=mysqli_fetch_assoc($resultado)) { ?> 
                    ...
                    <td><a class="btn btn-primary btn-sm" href="formProd.php?productId=<?php echo $row['productId']; ?>">EDITAR</a>
                        <a class="btn btn-danger btn-sm sm-4" href="eliminarPro.php?productId=<?php echo $row['productId']; ?>">ELIMINAR</a></td>
