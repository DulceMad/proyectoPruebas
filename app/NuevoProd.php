<?php
    ...
    //Obtener los datos de proveedores y categorias
...
<div class="container-md">
    ...
    <div style="margin-left: 5%;">
        <form action="registrarProd.php" method="POST">
            <div class="container py-5 h-100">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-12 col-md-8 col-lg-6 col-xl-10">
                        <div class="card shadow-2-strong" style="background-color: #828282;" >
                            <div class="card-body p-5 text-">
                                <h5 class="form-label" >Número de Producto</h5>
                                    <div class="form-outline mb-4">
                                        <input name="productId" placeholder="No. Producto"  type="number" class="form-control form-control-lg"/>
                                    </div>
                                <h5  class="form-label" >Nombre del Producto</h5>
                                <div class="form-outline mb-4">
                                    <input name="productname" placeholder="Nombre del producto " type="text" class="form-control form-control-lg"/>
                                </div>
                                <h5  class="form-label" >Precio</h5>
                                <div class="form-outline mb-4">
                                    <input name="price" placeholder="0.00" type="number" class="form-control form-control-lg"/>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    <select name="supplierId" class="form-select form-select-lg">
                                        ...
                                        while ($proveedor = mysqli_fetch_assoc($resultadoProveedores)){
                                            echo '<option value="' . $proveedor['id'] . '">' . $proveedor['suppliername'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    <input name="description" placeholder="Descripción del producto" type="text" class="form-control form-control-lg"/>
                                </div>
                                <h5  class="form-label" >stock</h5>
                                <div class="form-outline mb-4">
                                    <input name="stock" placeholder="Cantidad del producto en stock" type="number" class="form-control form-control-lg"/>
                                </div>
                                <h5  class="form-label" >Imagen</h5>
                                <div class="form-outline mb-4">
                                    <input name="image" placeholder="Imagen del producto" type="text" class="form-control form-control-lg"/>
                                </div>
