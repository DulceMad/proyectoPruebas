...
if (isset($_GET['id'])) {
    ...
    if ($row = mysqli_fetch_assoc($resultado)) {
        ...
        echo "<script> alert('El proveedor no existe'); window.location = 'tablaProv.php'</script>";
    }
    } else {
        echo "<script> alert('ID de proveedor no especificado'); window.location = 'tablaProv.php'</script>";
    }
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-10">
                        <div class="card shadow-2-strong" style="background-color: #828282;" >
                            <div class="card-body p-5 text-">
                                <h5 class="form-label" >Folio de proveedor</h5>
                                    <div class="form-outline mb-4">
                                        <input name="id" placeholder="No.proveedor"  type="number" class="form-control form-control-lg"
                                         value="<?php echo $id ?>" />
                                    </div>
                                <h5 class="form-label" >Proveedor</h5>
                                <div class="form-outline mb-4">
                                    <input name="suppliername" placeholder="Proveedor"  type="text" class="form-control form-control-lg" value="<?php echo $suppliername; ?>"/>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    <input name="supplieremail" placeholder="Email"  type="email" class="form-control form-control-lg" value="<?php echo $supplieremail; ?>"/>
                                </div>
                                <a href="tablaProv.php"> <button class="btn btn-dark btn-lg btn-block"
