...
if (isset($_GET['id'])) {
    ...
    if ($row = mysqli_fetch_assoc($resultado)) {
        ...
        echo "<script> alert('La categoria no existe'); window.location = 'tablaCat.php'</script>";
    }
    } else {
        echo "<script> alert('ID de categoria no especificado'); window.location = 'tablaCat.php'</script>";
    }
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-10">
                        <div class="card shadow-2-strong" style="background-color: #828282;" >
                            <div class="card-body p-5 text-">
                                <h5 class="form-label" >Folio de categoria</h5>
                                ...
                                <div class="form-outline mb-4">
                                    <input name="categoryname" placeholder="Categoria"  type="text" class="form-control form-control-lg" value="<?php echo $categoryname; ?>"/>
                                </div>
